...
const projects: Project[] = [
  ...
  },
  {
    ...
    Using TypeScript (TS) in a small project can be overkill as it usually requires some boilerplate code, but the amazing developer experience of using TS definitely outweighs the negatives.`,
